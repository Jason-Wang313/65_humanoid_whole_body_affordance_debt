...
Honest strongest claim: `Measure and minimize future affordance loss induced by current whole-body posture choices.` is a plausible branch-structured mechanism for humanoid whole-body manipulation, supported by synthetic multi-seed diagnostic evidence and hostile-prior-work-aware positioning.
